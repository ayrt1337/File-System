...
<template>
    <div class="relative group">
        ...
        <input v-model.trim="model" :type="password ? (showText ? 'text' : 'password') : 'text'" :placeholder="text"
            class="w-full py-3.5 px-11 bg-[#1a1a1a] border border-gray-800 rounded-full focus:outline-none focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-all duration-300 placeholder-gray-600 text-white" />
